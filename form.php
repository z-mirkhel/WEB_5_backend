      ...
      <div class="wrapper">
          <header class="header">
                  <div class="content-head">
                      ...
                      <div class="header__text">WEB_5</div>
                    </div>
      ...
      <div class="formm">
        ...
        <form class="form__body" method="post" action="">
                            ...
                            <div>
                                ...
                                <textarea id="comment" class="form-control shadow bg-white rounded form__input _req" type="text" name="bio" placeholder="Биография" ><?php print($value['bio']); ?></textarea>
                                <div class="text-danger err "
                                    <?php
                                        if(!$error['bio']){
                                            print('hidden');
                            ...
                            <div class="form__checkbox">
                                <input class="form-check-input checkbox__input _req" type="checkbox" id="userAgreement"  name="agree"
                                    <?php
                                        if($value['agree']){
                                            print('checked');
                                        }
